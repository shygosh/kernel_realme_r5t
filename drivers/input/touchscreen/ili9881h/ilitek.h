...
#define ipio_info(fmt, arg...) do { } while (0)

#define ipio_err(fmt, arg...) do { } while (0)

#define ipio_debug(level, fmt, arg...) do { } while (0)

#define oppo_debug(level, fmt, arg...) do { } while (0)
